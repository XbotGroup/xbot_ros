...
(cl:defmethod cl:initialize-instance :after ((m <DockInfraRed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DockInfraRed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xbot_msgs-msg:<DockInfraRed> is deprecated: use xbot_msgs-msg:DockInfraRed instead.")))
...
(cl:defmethod data-val ((m <DockInfraRed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xbot_msgs-msg:data-val is deprecated.  Use xbot_msgs-msg:data instead.")
  (data m))
